...
<template>
  <div class="flex flex-col lg:h-48">
    <div
      class="bg-eph-white border-1 border-solid border-zinc-200 rounded-2xl shadow-xl p-6 sm:p-4 lg:px-8 flex-auto flex flex-col lg:flex-row justify-center items-center gap-2 font-medium text-center lg:text-left"
    >
      <div
